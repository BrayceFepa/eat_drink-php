<?php
require_once('../fonctions/traitement_categorie.php');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="col-md-10" style="margin:auto;">
        <form action="addcategorie.php" method="post">
            ...
            <div class="form-group">
                <input type="text" class="form-control" placeholder="Nom categorie" name="nom" required="required">
            </div>
            <div class="form-group">
                <textarea  class="form-control" rows="" cols="" name="description" placeholder="Description categorie"></textarea>
            </div>
            <div class="form-group">
